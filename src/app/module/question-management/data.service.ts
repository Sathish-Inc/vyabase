...
export class DataService {
  ...
  //     this.dbService
  //       .getAll(
  //         QuestionManagementConstant.KEY_DOC_TYPE,
  //         QuestionManagementConstant.DOC_TYPE
  //       )
  //       .subscribe(
  //         (result: any) => {
  ...
  //     this.dbService
  //       .getAll(
  //         QuestionManagementHistoryConstant.KEY_DOC_TYPE,
  //         QuestionManagementHistoryConstant.DOC_TYPE
  //       )
  //       .subscribe(
  //         (result: any) => {
  //           observer.next(result);
  ...
  //   questionManagementHistory: QuestionManagementHistory
  // ): Observable<any> {
